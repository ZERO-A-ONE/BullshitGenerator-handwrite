...
if __name__ == '__main__':
    #主窗口
    window = tk.Tk()
    window.title('BullshitGenerator')
    window.geometry('300x400')
    #1标签
    l1 = tk.Label(window, text='主题', font=('Arial', 16), width=40, height=2)
    l1.pack(fill='x')
    e1 = tk.Entry(window, show=None, width=40, justify='center')  # 显示成明文形式
    e1.pack()
    #l2
    l2 = tk.Label(window, text='字数', font=('Arial', 16), width=40, height=2)
    l2.pack(fill='x')
    e2 = tk.Entry(window, show=None, width=10, justify='center')  # 显示成明文形式
    e2.pack()
    #l3
    l3 = tk.Label(window, text='字体大小', font=('Arial', 16), width=40, height=2)
    l3.pack(fill='x')
    e3 = tk.Entry(window, show=None, width=10, justify='center')  # 显示成明文形式
    e3.pack()
    #l4
    l4 = tk.Label(window, text='间距', font=('Arial', 16), width=40, height=2)
    l4.pack(fill='x')
    e4 = tk.Entry(window, show=None, width=10, justify='center')  # 显示成明文形式
    e4.pack()
    b = tk.Button(window, text='生成', font=('Arial', 12), width=10, height=1,command=buttonRK)
    b.pack()
    window.mainloop()
